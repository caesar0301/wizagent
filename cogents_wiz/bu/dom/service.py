...
from cogents_wiz.bu.dom.enhanced_snapshot import REQUIRED_COMPUTED_STYLES, build_snapshot_lookup
from cogents_wiz.bu.dom.serializer.serializer import DOMTreeSerializer
...
if TYPE_CHECKING:
    from cogents_wiz.bu.browser.session import BrowserSession
