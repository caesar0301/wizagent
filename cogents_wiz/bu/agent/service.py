...
from cogents_wiz.bu.tokens.service import TokenCost
...
from cogents_wiz.bu import Browser, BrowserProfile, BrowserSession

# Lazy import for gif to avoid heavy agent.views import at startup
# from cogents_wiz.bu.agent.gif import create_history_gif
from cogents_wiz.bu.agent.message_manager.service import MessageManager
from cogents_wiz.bu.agent.prompts import SystemPrompt
from cogents_wiz.bu.agent.views import (
    ActionResult,
    AgentError,
    AgentHistory,
    AgentHistoryList,
...
from cogents_wiz.bu.browser.session import DEFAULT_BROWSER_PROFILE
from cogents_wiz.bu.browser.views import BrowserStateSummary
...
class Agent(Generic[Context, AgentStructuredOutput]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if llm is None:
            ...
            if default_llm_name:
                try:
                    from cogents_wiz.bu.llm.models import get_llm_by_name
    ...
    def logger(self) -> logging.Logger:
        ...
        return logging.getLogger(
            f"cogents_wiz.bu.Agent🅰 {self.task_id[-4:]} ⇢ 🅑 {_browser_session_id[-4:]} 🅣 {_current_target_id}"
        )
    ...
    def _set_screenshot_service(self) -> None:
        ...
        try:
            from cogents_wiz.bu.screenshots.service import ScreenshotService
    ...
    async def run(
        ...
        try:
            ...
            from cogents_wiz.bu.browser.events import BrowserStartEvent
