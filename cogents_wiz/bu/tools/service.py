...
from cogents_wiz.bu.agent.views import ActionModel, ActionResult
...
from cogents_wiz.bu.browser.views import BrowserError
from cogents_wiz.bu.dom.service import EnhancedDOMTreeNode
...
from cogents_wiz.bu.tools.registry.service import Registry
from cogents_wiz.bu.tools.views import (
    ClickElementAction,
    CloseTabAction,
    DoneAction,
...
from cogents_wiz.bu.utils import _log_pretty_url, time_execution_sync
            ...
            try:
                ...
                for i, tab in enumerate(tabs):
                    ...
                    if tab.url and tab.url.strip("/").lower() in ("https://www.google.com", "https://google.com"):
                        ...
                        from cogents_wiz.bu.browser.events import SwitchTabEvent
...
""".strip()
        ...
        async def select_dropdown_option(params: SelectDropdownOptionAction, browser_session: BrowserSession):
            ...
            from cogents_wiz.bu.browser.events import SelectDropdownOptionEvent
