    ...
    class BrowserUseFormatter(logging.Formatter):
        ...
        def format(self, record):
            ...
            if (
                ...
                and record.name.startswith("cogents_wiz.bu.")
            ):
                ...
                if "Agent" in record.name:
                    ...
                    record.name = "dom"
                elif record.name.startswith("cogents_wiz.bu."):
...
def setup_log_pipes(session_id: str, base_dir: str | None = None):
    ...
    for name in ["cogents_wiz.bu.agent", "cogents_wiz.bu.tools"]:
    ...
    for name in ["bubus", "cogents_wiz.bu.browser.session"]:
        logger = logging.getLogger(name)
