...
from cogents_wiz.bu.browser.events import BrowserErrorEvent, BrowserStateRequestEvent, ScreenshotEvent, TabCreatedEvent
from cogents_wiz.bu.browser.watchdog_base import BaseWatchdog
from cogents_wiz.bu.dom.service import DomService
from cogents_wiz.bu.dom.views import EnhancedDOMTreeNode, SerializedDOMState
from cogents_wiz.bu.observability import observe_debug
from cogents_wiz.bu.utils import time_execution_async

if TYPE_CHECKING:
    from cogents_wiz.bu.browser.views import BrowserStateSummary, PageInfo
...
class DOMWatchdog(BaseWatchdog):
        ...
        try:
            ...
            if (
                ...
                try:
                    ...
                    from cogents_wiz.bu.browser.python_highlights import create_highlighted_screenshot_async
    ...
    async def _get_page_info(self) -> "PageInfo":
        ...
        from cogents_wiz.bu.browser.views import PageInfo
