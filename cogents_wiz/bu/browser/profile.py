...
from cogents_wiz.bu.utils import _log_pretty_path, logger
...
# Using constants from central location in cogents_wiz.bu.config
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
    ...
    proxy: ProxySettings | None = Field(
        default=None,
        description="Proxy settings. Use cogents_wiz.bu.browser.profile.ProxySettings(server, bypass, username, password)",
    )
