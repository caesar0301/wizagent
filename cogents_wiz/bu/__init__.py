...
if TYPE_CHECKING:
    ...
    from cogents_wiz.bu.browser import BrowserProfile
    from cogents_wiz.bu.browser import BrowserSession
...
_LAZY_IMPORTS = {
    ...
    "Agent": ("cogents_wiz.bu.agent.service", "Agent"),
    # System prompt (moderate weight due to agent.views imports)
    "SystemPrompt": ("cogents_wiz.bu.agent.prompts", "SystemPrompt"),
    # Agent views (very heavy - over 1 second!)
    "ActionModel": ("cogents_wiz.bu.agent.views", "ActionModel"),
    "ActionResult": ("cogents_wiz.bu.agent.views", "ActionResult"),
    "AgentHistoryList": ("cogents_wiz.bu.agent.views", "AgentHistoryList"),
    "BrowserSession": ("cogents_wiz.bu.browser", "BrowserSession"),
    "Browser": ("cogents_wiz.bu.browser", "BrowserSession"),  # Alias for BrowserSession
    "BrowserProfile": ("cogents_wiz.bu.browser", "BrowserProfile"),
    # Tools (moderate weight)
    "Tools": ("cogents_wiz.bu.tools.service", "Tools"),
    "Controller": ("cogents_wiz.bu.tools.service", "Controller"),  # alias
    # DOM service (moderate weight)
    "DomService": ("cogents_wiz.bu.dom.service", "DomService"),
    ...
    # LLM models module
    "models": ("cogents_wiz.bu.llm.models", None),
}
