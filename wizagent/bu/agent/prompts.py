...
from wizagent.bu.llm_adapter import ContentImage, ContentText, SystemMessage, UserMessage
...
if TYPE_CHECKING:
    from wizagent.bu.agent.views import AgentStepInfo
...
class SystemPrompt:
    ...
    def _load_prompt_template(self) -> None:
        ...
        try:
            ...
            with (
                importlib.resources.files("wizagent.bu.agent")
