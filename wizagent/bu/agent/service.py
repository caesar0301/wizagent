...
from wizagent.bu.agent.message_manager.utils import save_conversation
from wizagent.bu.llm.base import BaseChatModel
from wizagent.bu.llm.messages import BaseMessage, ContentPartImageParam, ContentPartTextParam, UserMessage
from wizagent.bu.llm.openai.chat import ChatOpenAI
from wizagent.bu.tokens.service import TokenCost
...
from wizagent.bu import Browser, BrowserProfile, BrowserSession

# Lazy import for gif to avoid heavy agent.views import at startup
# from wizagent.bu.agent.gif import create_history_gif
from wizagent.bu.agent.message_manager.service import MessageManager
from wizagent.bu.agent.prompts import SystemPrompt
from wizagent.bu.agent.views import (
    ActionResult,
    AgentError,
    AgentHistory,
    AgentHistoryList,
...
from wizagent.bu.browser.session import DEFAULT_BROWSER_PROFILE
from wizagent.bu.browser.views import BrowserStateSummary
from wizagent.bu.config import CONFIG
from wizagent.bu.dom.views import DOMInteractedElement
from wizagent.bu.filesystem.file_system import FileSystem
from wizagent.bu.observability import observe, observe_debug
from wizagent.bu.tools.registry.views import ActionModel
from wizagent.bu.tools.service import Tools
from wizagent.bu.utils import (
    _log_pretty_path,
...
class Agent(Generic[Context, AgentStructuredOutput]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if llm is None:
            ...
            if default_llm_name:
                try:
                    from wizagent.bu.llm.models import get_llm_by_name
    ...
    def logger(self) -> logging.Logger:
        ...
        return logging.getLogger(
            f"wizagent.bu.Agent🅰 {self.task_id[-4:]} ⇢ 🅑 {_browser_session_id[-4:]} 🅣 {_current_target_id}"
        )
    ...
    def _set_screenshot_service(self) -> None:
        ...
        try:
            from wizagent.bu.screenshots.service import ScreenshotService
    ...
    async def run(
        ...
        from wizagent.bu.utils import SignalHandler
        ...
        try:
            ...
            from wizagent.bu.browser.events import BrowserStartEvent
