...
from wizagent.bu.browser.events import (
...
from wizagent.bu.browser.views import BrowserStateSummary, TabInfo
from wizagent.bu.dom.views import EnhancedDOMTreeNode, TargetInfo
from wizagent.bu.observability import observe_debug
from wizagent.bu.utils import _log_pretty_url, is_new_tab_page
...
class CDPSession(BaseModel):
    ...
    async def for_target(
        ...
        if new_socket:
            ...
            logger = logging.getLogger(f"wizagent.bu.CDPSession.{target_id[-4:]}")
...
class BrowserSession(BaseModel):
    ...
    def logger(self) -> Any:
        ...
        # 	self._logger = logging.getLogger(f'wizagent.bu.{self}')
        return logging.getLogger(f"wizagent.bu.{self}")
    ...
    def model_post_init(self, __context) -> None:
        ...
        from wizagent.bu.browser.watchdog_base import BaseWatchdog
    ...
    async def kill(self) -> None:
        ...
        from wizagent.bu.browser.events import SaveStorageStateEvent
    ...
    async def on_NavigateToUrlEvent(self, event: NavigateToUrlEvent) -> None:
        ...
        if event.new_tab:
            try:
                ...
                from wizagent.bu.utils import is_new_tab_page
    ...
    async def attach_all_watchdogs(self) -> None:
        ...
        from wizagent.bu.browser.watchdogs.aboutblank_watchdog import AboutBlankWatchdog

        # from wizagent.bu.browser.crash_watchdog import CrashWatchdog
        from wizagent.bu.browser.watchdogs.default_action_watchdog import DefaultActionWatchdog
        from wizagent.bu.browser.watchdogs.dom_watchdog import DOMWatchdog
        from wizagent.bu.browser.watchdogs.downloads_watchdog import DownloadsWatchdog
        from wizagent.bu.browser.watchdogs.local_browser_watchdog import LocalBrowserWatchdog
        from wizagent.bu.browser.watchdogs.permissions_watchdog import PermissionsWatchdog
        from wizagent.bu.browser.watchdogs.popups_watchdog import PopupsWatchdog
        from wizagent.bu.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
        from wizagent.bu.browser.watchdogs.security_watchdog import SecurityWatchdog

        # from wizagent.bu.browser.storage_state_watchdog import StorageStateWatchdog
