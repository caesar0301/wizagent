...
from wizagent.bu.utils import _log_pretty_path, logger
...
# Using constants from central location in wizagent.bu.config
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
    ...
    proxy: ProxySettings | None = Field(
        default=None,
        description="Proxy settings. Use wizagent.bu.browser.profile.ProxySettings(server, bypass, username, password)",
    )
