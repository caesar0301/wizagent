...
from wizagent.bu.browser.events import BrowserErrorEvent, BrowserStateRequestEvent, ScreenshotEvent, TabCreatedEvent
from wizagent.bu.browser.watchdog_base import BaseWatchdog
from wizagent.bu.dom.service import DomService
from wizagent.bu.dom.views import EnhancedDOMTreeNode, SerializedDOMState
from wizagent.bu.observability import observe_debug
from wizagent.bu.utils import time_execution_async

if TYPE_CHECKING:
    from wizagent.bu.browser.views import BrowserStateSummary, PageInfo
...
class DOMWatchdog(BaseWatchdog):
        ...
        try:
            ...
            if (
                ...
                try:
                    ...
                    from wizagent.bu.browser.python_highlights import create_highlighted_screenshot_async
    ...
    async def _get_page_info(self) -> "PageInfo":
        ...
        from wizagent.bu.browser.views import PageInfo
