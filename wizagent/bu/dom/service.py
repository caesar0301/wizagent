...
from wizagent.bu.dom.enhanced_snapshot import REQUIRED_COMPUTED_STYLES, build_snapshot_lookup
from wizagent.bu.dom.serializer.serializer import DOMTreeSerializer
from wizagent.bu.dom.views import (
    CurrentPageTargets,
    DOMRect,
    EnhancedAXNode,
    EnhancedAXProperty,
...
if TYPE_CHECKING:
    from wizagent.bu.browser.session import BrowserSession
