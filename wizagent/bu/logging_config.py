    ...
    class BrowserUseFormatter(logging.Formatter):
        ...
        def format(self, record):
            ...
            if (
                ...
                and record.name.startswith("wizagent.bu.")
            ):
                ...
                if "Agent" in record.name:
                    ...
                    record.name = "dom"
                elif record.name.startswith("wizagent.bu."):
...
def setup_log_pipes(session_id: str, base_dir: str | None = None):
    ...
    for name in ["wizagent.bu.agent", "wizagent.bu.tools"]:
    ...
    for name in ["bubus", "wizagent.bu.browser.session"]:
        logger = logging.getLogger(name)
