...
from wizagent.bu.agent.views import ActionModel, ActionResult
...
from wizagent.bu.browser.views import BrowserError
from wizagent.bu.dom.service import EnhancedDOMTreeNode
...
from wizagent.bu.tools.registry.service import Registry
from wizagent.bu.tools.views import (
    ClickElementAction,
    CloseTabAction,
    DoneAction,
...
from wizagent.bu.utils import _log_pretty_url, time_execution_sync
...
""".strip()
        ...
        async def select_dropdown_option(params: SelectDropdownOptionAction, browser_session: BrowserSession):
            ...
            from wizagent.bu.browser.events import SelectDropdownOptionEvent
