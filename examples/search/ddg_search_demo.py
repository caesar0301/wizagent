...
from wizagent.search import DuckDuckGoSearch, DuckDuckGoSearchConfig, DuckDuckGoSearchError
...
def basic_search_example():
    ...
    print("Basic DuckDuckGo Search Example")

    try:
        # Initialize search with default configuration
...
def search_with_parameters_example():
    ...
    try:
        ...
        result = search.search(query, max_results=3, region="uk-en", safesearch="off", timelimit="w")  # Last week
...
async def async_search_example():
    ...
    try:
        ...
        tasks = [search.async_search(query, max_results=3) for query in queries]
...
def error_handling_example():
    ...
    try:
        ...
        try:
            result = search.search(long_query, max_results=1)
...
def main():
    ...
    search_with_parameters_example()
